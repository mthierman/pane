...
struct window final {
    ...
    window(window_config&& window_config = {},
           std::function<LRESULT(Self*, window_message)>&& window_procedure
...
public:
    ...
    window_class<Self> window_class { u8"PaneWindow", window_class_procedure };
    window_background window_background { pane::system::dark_mode()
...
struct webview_config final {
    ...
    std::function<void(webview*)> creation_callback;
...
public:
    ...
    webview_config webview_config;
    uintptr_t id { pane::random_number<uintptr_t>() };
    window_class<Self> window_class { u8"PaneWebView", window_class_procedure };
    window_background window_background { pane::system::dark_mode()
                                              ? window_config.dark_background
                                              : window_config.light_background };
    window_handle window_handle;
